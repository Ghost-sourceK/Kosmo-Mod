package kosmomod.cards;

import basemod.abstracts.CustomCard;
import kosmomod.character.KosmoCharacter;
import kosmomod.util.CardArtRoller;
...
import static kosmomod.KosmoMod.makeImagePath;
import static kosmomod.KosmoMod.modID;
import static kosmomod.util.Wiz.*;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        super(cardID, "", getCardTextureString(cardID.replace(modID + ":", ""), type), cost, "", type, color, rarity, target);
