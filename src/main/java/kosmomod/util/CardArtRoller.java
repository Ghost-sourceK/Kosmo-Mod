...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(KosmoMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(KosmoMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(KosmoMod.makeImagePath("masks/PowerMask.png"));
